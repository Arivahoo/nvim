...
require'nvim-treesitter.configs'.setup {
  ...
  ensure_installed = { "haskell", "haskell_persistent" },
...
vim.keymap.set("n", "<Leader>t", ":Haskell repl toggle <CR>", {desc = 'reload repl in '})
vim.keymap.set("n", "<Leader>q", ":Haskell repl load <CR>", opts)
...
vim.keymap.set('n', '<Leader>a', '<Plug>HaskellHoverAction')
